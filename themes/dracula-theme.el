...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(mode-line-inactive ((,class (:foreground ,fg4 :background ,bg2))))
   `(vertical-border ((,class (:foreground ,bg2))))
   `(minibuffer-prompt ((,class (:bold t :foreground ,keyword))))
   `(default-italic ((,class (:italic t))))
   `(link ((,class (:foreground ,const :underline t))))
   `(linum ((,class (:slant normal :foreground ,bg4 :background ,bg1))))
   `(linum-highlight-face ((,class (:foreground ,comment :background ,bg1))))
   `(org-code ((,class (:foreground ,fg2))))
   `(org-hide ((,class (:foreground ,fg4))))
   `(org-level-1 ((,class (:bold t :foreground ,fg2))))
   `(org-level-2 ((,class (:bold nil :foreground ,keyword))))
   `(org-level-3 ((,class (:bold nil :foreground ,comment))))
   `(org-level-4 ((,class (:bold nil :foreground ,comment))))
   `(org-tag ((,class (:bold t :foreground ,comment :height 0.9))))
   ...
   `(org-warning ((,class (:foreground ,fg1))))
   `(org-scheduled-previously ((,class (:foreground ,fg1))))
   `(org-agenda-structure ((,class (:weight bold :foreground ,fg3 :underline ,fg3))))
   `(org-agenda-date ((,class :weight normal :foreground ,const)))
   `(org-agenda-date-weekend ((,class (:weight normal :foreground ,const))))
   `(org-agenda-date-today ((,class (:weight bold :foreground ,func))))
   `(org-agenda-done ((,class (:foreground ,fg1 :strike-through ,fg1))))
   `(org-scheduled ((,class (:foreground ,fg1))))
   `(org-upcoming-deadline ((,class (:foreground ,fg1))))
   ...
   `(guide-key/prefix-command-face ((,class (:foreground ,builtin :weight bold))))
   ...
   `(helm-buffer-directory ((,class (:foreground ,func :background ,bg1 :weight bold))))
