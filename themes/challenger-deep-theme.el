  ...
  (let* ((bg              "#1b182c")
    ...
    (custom-theme-set-faces
     ...
     `(org-meta-line             ((,c (:foreground ,doc-comments))
                                  (,ct (:foreground ,ct-doc-comments))))
     `(org-block                 ((,c (:background "#211d35" :foreground ,green :inherit fixed-pitch))
                                  (,ct (:background ,ct-grey-ddd, :foreground ,ct-green :inherit fixed-pitch))))
     `(org-block-begin-line      ((,c (:foreground ,blue :inherit org-block :box (:line-width 2 :color "#211d35")))
                                  (,ct (:foreground ,blue :inherit org-block))))
     `(org-block-end-line        ((,c (:inherit org-block-begin-line))
                                  (,ct (:inherit org-block-begin-line))))
     `(org-block-background      ((,c (:inherit org-block))
                                  (,ct (:inherit org-block))))
     `(org-archived              ((,c (:foreground ,grey))
                                  (,ct (:foreground ,ct-grey))))
     `(org-document-title        ((,c (:foreground ,cyan :height 1.0))
                                  (,ct (:foreground ,ct-cyan :height 1.0))))
     `(org-level-1               ((,c (:foreground ,red :height 1.0))
                                  (,ct (:foreground ,ct-red :bold ,bold :height 1.0))))
     `(org-level-2               ((,c (:foreground ,magenta :height 1.0))
                                  (,ct (:foreground ,ct-magenta :height 1.0))))
     `(org-level-3               ((,c (:foreground ,magenta :height 1.0))
                                  (,ct (:foreground ,ct-magenta :height 1.0))))
     ...
     `(org-code                  ((,c (:foreground ,red-d))
                                  (,ct (:foreground ,ct-red-d))))
     `(org-verbatim              ((,c (:foreground ,cyan :inherit fixed-pitch))
                                  (,ct (:foreground ,ct-cyan :inherit fixed-pitch))))
     ...
     `(org-date                  ((,c (:foreground ,magenta-d))
                                  (,ct (:foreground ,ct-magenta-d))))
     `(org-todo                  ((,c (:foreground ,red :bold inherit))
                                  (,ct (:foreground ,ct-red :bold inherit))))
